...
class ManagerPage(BasePage):
    ...
    def get_customer_data_from_row(self):
        first_name = self.find_element(ManagerPageLocators.ALL_FIRST_NAME_CELLS).text
        last_name = self.find_element(ManagerPageLocators.ALL_LAST_NAME_CELLS).text
        post_code = self.find_element(ManagerPageLocators.ALL_POST_CODE_CELLS).text
        return {
    ...
    def get_customer_first_names(self):
        self.find_element(ManagerPageLocators.CUSTOMERS_TABLE)
        name_cells = self.find_elements(ManagerPageLocators.ALL_FIRST_NAME_CELLS)
